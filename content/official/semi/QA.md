...
> Generated by `pnpm pipeline verify semi` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 440
...
| --------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`            | #0064FA       | #0064FA              | exact   |
| `colors.primary-tint`       | #EAF5FF       | #EAF5FF              | exact   |
| `colors.on-primary`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface`            | #FFFFFF       | #FFFFFF              | exact   |
| `colors.on-surface`         | #1C1F23       | #1C1F23              | exact   |
| `colors.on-surface-variant` | #41464C       | #41464C              | exact   |
| `colors.helper`             | #6B7075       | #6B7075              | exact   |
| `colors.fill`               | #F5F5F5       | #F9F9F9              | close   |
| `colors.border`             | #EDEDED       | #E6E8EA              | close   |
| `colors.success`            | #3BB346       | #3BB346              | exact   |
| `colors.success-tint`       | #ECF7EC       | #ECF7EC              | exact   |
| `colors.warning`            | #FC8800       | #FC8800              | exact   |
| `colors.warning-tint`       | #FFF8EA       | #FFF8EA              | exact   |
| `colors.danger`             | #F93920       | #F93920              | exact   |
| `colors.danger-tint`        | #FEF2ED       | #FEF2ED              | exact   |
