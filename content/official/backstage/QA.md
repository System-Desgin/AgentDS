...
> Generated by `pnpm pipeline verify backstage` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 61
- Colors grounded in source: **14/14**
  (exact 14 · close 0 · drift 0 · unmatched 0)
- Files read:
  - /dist/base/palettes.esm.js
  - /dist/base/pageTheme.esm.js

| Token                | Value in file | Nearest source color | Verdict |
| -------------------- | ------------- | -------------------- | ------- |
| `colors.primary`     | #1F5493       | #1F5493              | exact   |
| `colors.on-primary`  | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface`     | #F8F8F8       | #F8F8F8              | exact   |
| `colors.paper`       | #FFFFFF       | #FFFFFF              | exact   |
| `colors.on-surface`  | #000000       | #000000              | exact   |
| `colors.text-subtle` | #6E6E6E       | #6E6E6E              | exact   |
| `colors.border`      | #E6E6E6       | #E6E6E6              | exact   |
| `colors.link`        | #0A6EBE       | #0A6EBE              | exact   |
| `colors.header`      | #171717       | #171717              | exact   |
| `colors.on-header`   | #FFFFFF       | #FFFFFF              | exact   |
| `colors.nav-muted`   | #B5B5B5       | #B5B5B5              | exact   |
| `colors.success`     | #1DB954       | #1DB954              | exact   |
| `colors.warning`     | #FF9800       | #FF9800              | exact   |
| `colors.error`       | #E22134       | #E22134              | exact   |
