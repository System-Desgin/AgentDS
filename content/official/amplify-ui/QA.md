...
> Generated by `pnpm pipeline verify amplify-ui` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 66
...
- Files read:
  ...
  - /dist/styles.css
  - /dist/styles/base.layer.css
  - /dist/styles/base.css
  - /dist/styles/button.layer.css
  - /dist/styles/button.css
  - /dist/styles/toggleButton.layer.css
  - …and 2 more

| Token                       | Value in file | Nearest source color | Verdict |
| --------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`            | #047D95       | #047D95              | exact   |
| `colors.primary-hover`      | #005566       | #005566              | exact   |
| `colors.on-primary`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface`            | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface-variant`    | #FAFAFA       | #FAFAFA              | exact   |
| `colors.surface-tertiary`   | #EFF0F0       | #EFF0F0              | exact   |
| `colors.on-surface`         | #0D1926       | #0D1A26              | close   |
| `colors.on-surface-variant` | #304050       | #304050              | exact   |
| `colors.border`             | #89949F       | #89949F              | exact   |
| `colors.focus`              | #00404C       | #00404D              | close   |
| `colors.success`            | #365E3D       | #365E3D              | exact   |
| `colors.warning`            | #663300       | #663300              | exact   |
| `colors.error`              | #660000       | #660000              | exact   |
