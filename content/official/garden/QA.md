...
> Generated by `pnpm pipeline verify garden` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 206
...
| -------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`           | #1F73B7       | #1F73B7              | exact   |
| `colors.on-primary`        | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface`           | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface-subtle`    | #F8F9F9       | #F8F9F9              | exact   |
| `colors.on-surface`        | #293239       | #293239              | exact   |
| `colors.on-surface-subtle` | #5C6970       | #5C6970              | exact   |
| `colors.border`            | #D8DCDE       | #D8DCDE              | exact   |
| `colors.border-subtle`     | #E8EAEC       | #E8EAEC              | exact   |
| `colors.chrome`            | #16494F       | #16494F              | exact   |
| `colors.on-chrome`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.success`           | #037F52       | #037F52              | exact   |
| `colors.warning`           | #AC5918       | #AC5918              | exact   |
| `colors.danger`            | #CD3642       | #CD3642              | exact   |
