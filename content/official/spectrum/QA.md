...
> Generated by `pnpm pipeline verify spectrum` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 609
...
| ------------------------ | ------------- | -------------------- | ------- |
| `colors.primary`         | #3B63FB       | #3B63FB              | exact   |
| `colors.on-primary`      | #FFFFFF       | #FFFFFF              | exact   |
| `colors.background`      | #FFFFFF       | #FFFFFF              | exact   |
| `colors.layer-1`         | #F8F8F8       | #F8F8F8              | exact   |
| `colors.gray-100`        | #E9E9E9       | #E9E9E9              | exact   |
| `colors.neutral-content` | #292929       | #292929              | exact   |
| `colors.neutral-subdued` | #505050       | #505050              | exact   |
| `colors.helper`          | #717171       | #717171              | exact   |
| `colors.border`          | #DADADA       | #DADADA              | exact   |
| `colors.border-strong`   | #8F8F8F       | #8F8F8F              | exact   |
| `colors.focus`           | #4B75FF       | #4B75FF              | exact   |
| `colors.positive`        | #05834E       | #05834E              | exact   |
| `colors.notice`          | #C24E00       | #C24E00              | exact   |
| `colors.negative`        | #D73220       | #D73220              | exact   |
| `colors.warning`         | #724800       | #724800              | exact   |
