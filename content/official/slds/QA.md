...
> Generated by `pnpm pipeline verify slds` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 370
- Colors grounded in source: **13/13**
  (exact 13 · close 0 · drift 0 · unmatched 0)
- Files read:
  - /design-tokens/dist/primitive.raw.json
  - /design-tokens/dist/primitive.ios.json
  - /design-tokens/dist/palettes.raw.json
  - /design-tokens/dist/colors.raw.json
  - /design-tokens/dist/primitive.json
  - /design-tokens/dist/palettes.json
  - /design-tokens/dist/transparent-colors.raw.json
  - /design-tokens/dist/colors.json
  - …and 32 more

| Token                       | Value in file | Nearest source color | Verdict |
| --------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`            | #0176D3       | #0176D3              | exact   |
| `colors.on-primary`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.primary-hover`      | #014486       | #014486              | exact   |
| `colors.surface`            | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface-variant`    | #F3F3F3       | #F3F3F3              | exact   |
| `colors.on-surface`         | #181818       | #181818              | exact   |
| `colors.on-surface-variant` | #444444       | #444444              | exact   |
| `colors.link`               | #0B5CAB       | #0B5CAB              | exact   |
| `colors.border`             | #C9C9C9       | #C9C9C9              | exact   |
| `colors.border-strong`      | #747474       | #747474              | exact   |
| `colors.success`            | #2E844A       | #2E844A              | exact   |
| `colors.warning`            | #A96404       | #A96404              | exact   |
| `colors.error`              | #BA0517       | #BA0517              | exact   |
