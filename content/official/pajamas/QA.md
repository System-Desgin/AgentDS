...
> Generated by `pnpm pipeline verify pajamas` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 188
- Colors grounded in source: **15/15**
  (exact 15 · close 0 · drift 0 · unmatched 0)
- Files read:
  - /src/tokens/deprecated/deprecated.color.data_viz.tokens.json
  - /src/tokens/deprecated/deprecated.color.tokens.json
  - /src/tokens/constant/color.data.tokens.json
  - /src/tokens/constant/color.alpha.tokens.json
  - /src/tokens/constant/color.brand.tokens.json
  - /src/tokens/deprecated/deprecated.color.transparency.tokens.json
  - /src/tokens/constant/color.neutral.tokens.json
  - /src/tokens/constant/color.green.tokens.json
  - …and 32 more

| Token                      | Value in file | Nearest source color | Verdict |
| -------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`           | #3A383F       | #3A383F              | exact   |
| `colors.on-primary`        | #FFFFFF       | #FFFFFF              | exact   |
| `colors.action`            | #1F75CB       | #1F75CB              | exact   |
| `colors.link`              | #2F5CA0       | #2F5CA0              | exact   |
| `colors.surface`           | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface-subtle`    | #FBFAFD       | #FBFAFD              | exact   |
| `colors.surface-strong`    | #ECECEF       | #ECECEF              | exact   |
| `colors.on-surface`        | #3A383F       | #3A383F              | exact   |
| `colors.on-surface-subtle` | #626168       | #626168              | exact   |
| `colors.on-surface-strong` | #18171D       | #18171D              | exact   |
| `colors.border`            | #DCDCDE       | #DCDCDE              | exact   |
| `colors.control-border`    | #89888D       | #89888D              | exact   |
| `colors.success`           | #108548       | #108548              | exact   |
| `colors.warning`           | #AB6100       | #AB6100              | exact   |
| `colors.danger`            | #DD2B0E       | #DD2B0E              | exact   |
