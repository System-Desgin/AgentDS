...
> Generated by `pnpm pipeline verify arco` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 273
- Colors grounded in source: **13/13**
  (exact 13 · close 0 · drift 0 · unmatched 0)
- Files read:
  - /dist/css/arco.css
  - /es/style/theme/color/colors.less
  - /lib/style/theme/color/colors.less
  - /es/style/theme/color/compiled-colors.less
  - /lib/style/theme/color/compiled-colors.less
  - /es/Button/style/token.less
  - /lib/Button/style/token.less

| Token                       | Value in file | Nearest source color | Verdict |
| --------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`            | #165DFF       | #165DFF              | exact   |
| `colors.on-primary`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.primary-active`     | #0E42D2       | #0E42D2              | exact   |
| `colors.surface`            | #FFFFFF       | #FFFFFF              | exact   |
| `colors.on-surface`         | #1D2129       | #1D2129              | exact   |
| `colors.on-surface-variant` | #4E5969       | #4E5969              | exact   |
| `colors.helper`             | #86909C       | #86909C              | exact   |
| `colors.surface-variant`    | #F2F3F5       | #F2F3F5              | exact   |
| `colors.border`             | #E5E6EB       | #E5E6EB              | exact   |
| `colors.success`            | #00B42A       | #00B42A              | exact   |
| `colors.warning`            | #FF7D00       | #FF7D00              | exact   |
| `colors.warning-surface`    | #FFF7E8       | #FFF7E8              | exact   |
| `colors.error`              | #F53F3F       | #F53F3F              | exact   |
