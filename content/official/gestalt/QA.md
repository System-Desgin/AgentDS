...
> Generated by `pnpm pipeline verify gestalt` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 253
...
- Files read:
  ...
  - /tokens/vr-theme-web-mapping/base-color-dataviz-dark.json
  - /tokens/vr-theme-web-mapping/base-color-dataviz-light.json
  - /tokens/classic/base-color-dataviz-dark.json
  - /tokens/classic/base-color-dataviz-light.json
  - /tokens/classic/comp-web-color-light.json
  - /tokens/classic/comp-web-color-dark.json
  - …and 32 more

| Token                       | Value in file | Nearest source color | Verdict |
| --------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`            | #E60023       | #E60023              | exact   |
| `colors.primary-strong`     | #B60000       | #B60000              | exact   |
| `colors.on-primary`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface`            | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface-variant`    | #E9E9E9       | #E9E9E9              | exact   |
| `colors.on-surface`         | #111111       | #111111              | exact   |
| `colors.on-surface-variant` | #767676       | #767676              | exact   |
| `colors.border`             | #CDCDCD       | #CDCDCD              | exact   |
| `colors.border-strong`      | #767676       | #767676              | exact   |
| `colors.info`               | #0074E8       | #0074E8              | exact   |
| `colors.success`            | #008753       | #008753              | exact   |
| `colors.warning`            | #BD5B00       | #BD5B00              | exact   |
| `colors.error`              | #CC0000       | #CC0000              | exact   |
