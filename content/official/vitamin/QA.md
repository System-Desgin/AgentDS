...
> Generated by `pnpm pipeline verify vitamin` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 40
- Colors grounded in source: **14/14**
  (exact 12 · close 2 · drift 0 · unmatched 0)
- Files read:
  - /src/base-colors.css
  - /src/legacy-colors.css
  - /dist/index-base10.css
  - /dist/index-base10.less
  - /dist/index-base10.scss
  - /src/themes/core-dark.css
  - /src/themes/core-light.css
  - /src/themes/default.css
  - …and 4 more

| Token                         | Value in file | Nearest source color | Verdict |
| ----------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`              | #007DBC       | #007DBC              | exact   |
| `colors.on-primary`           | #FFFFFF       | #FFFFFF              | exact   |
| `colors.action`               | #00699D       | #00689D              | close   |
| `colors.accent`               | #FFE928       | #FFEA28              | close   |
| `colors.surface`              | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface-secondary`    | #F7F8F9       | #F7F8F9              | exact   |
| `colors.surface-tertiary`     | #EFF1F3       | #EFF1F3              | exact   |
| `colors.on-surface`           | #001018       | #001018              | exact   |
| `colors.on-surface-secondary` | #4E5D6B       | #4E5D6B              | exact   |
| `colors.on-surface-tertiary`  | #687787       | #687787              | exact   |
| `colors.border`               | #D9DDE1       | #D9DDE1              | exact   |
| `colors.positive`             | #23A942       | #23A942              | exact   |
| `colors.warning`              | #FF600A       | #FF600A              | exact   |
| `colors.negative`             | #E32C26       | #E32C26              | exact   |
