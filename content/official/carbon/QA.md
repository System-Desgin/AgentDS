...
> Generated by `pnpm pipeline verify carbon` on 2026-08-01. Every
...
| --------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`            | #0F62FE       | #0F62FE              | exact   |
| `colors.on-primary`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.surface`            | #FFFFFF       | #FFFFFF              | exact   |
| `colors.on-surface`         | #161616       | #161616              | exact   |
| `colors.on-surface-variant` | #525252       | #525252              | exact   |
| `colors.surface-variant`    | #F4F4F4       | #F4F4F4              | exact   |
| `colors.helper`             | #6F6F6F       | #6F6F6F              | exact   |
| `colors.border-subtle`      | #E0E0E0       | #E0E0E0              | exact   |
| `colors.border-strong`      | #8D8D8D       | #8D8D8D              | exact   |
| `colors.success`            | #24A148       | #24A148              | exact   |
| `colors.warning`            | #F1C21B       | #F1C21B              | exact   |
| `colors.error`              | #DA1E28       | #DA1E28              | exact   |

## Sign-off

- Automated checks (schema, lint, colour spot-check, license, fonts) completed by the pipeline.
- Source verification: **passed** — 12/12 colors traced to `npm` source on 2026-08-01 (`pnpm pipeline verify`). CI re-runs this on every content change.
