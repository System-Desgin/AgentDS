...
> Generated by `pnpm pipeline verify vaadin-lumo` on 2026-08-01. Every
...
- Source type: `npm`
- Distinct colors recovered from source: 109
- Colors grounded in source: **13/13**
  (exact 11 · close 2 · drift 0 · unmatched 0)
- Files read:
  - /src/props/color.css
  - /src/global/color-scheme.css
  - /src/mixins/field-base.css
  - /dist/lumo.css
  - /dist/utility.css
  - /src/utilities/border.css
  - /src/global/badge.css

| Token                       | Value in file | Nearest source color | Verdict |
| --------------------------- | ------------- | -------------------- | ------- |
| `colors.primary`            | #006AF5       | #006AF5              | exact   |
| `colors.on-primary`         | #FFFFFF       | #FFFFFF              | exact   |
| `colors.primary-text`       | #005FDB       | #005FDB              | exact   |
| `colors.primary-tint`       | #E4F0FF       | #E2EEFE              | close   |
| `colors.surface`            | #FFFFFF       | #FFFFFF              | exact   |
| `colors.contrast-5`         | #F5F9FF       | #F5F9FF              | exact   |
| `colors.contrast-10`        | #F5F9FF       | #F5F9FF              | exact   |
| `colors.on-surface`         | #263445       | #233348              | close   |
| `colors.on-surface-variant` | #097FAA       | #097FAA              | exact   |
| `colors.border`             | #D1E3FA       | #D1E3FA              | exact   |
| `colors.success`            | #0A7637       | #0A7637              | exact   |
| `colors.error`              | #CA150C       | #CA150C              | exact   |
| `colors.warning`            | #FFCC00       | #FFCC00              | exact   |
